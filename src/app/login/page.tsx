        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">
              Ruaj veturat e preferuara dhe rezervo online
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-xl transition-all"
            >
          ...
          <p className="text-xs text-gray-400 text-center mt-6">
            ...
            <span className="text-gray-500">kushtet e përdorimit</span> dhe{" "}
            <span className="text-gray-500">politikën e privatësisë</span>
          </p>
        </div>
