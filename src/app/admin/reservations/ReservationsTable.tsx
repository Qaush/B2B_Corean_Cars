...
const statusOptions = [
  ...
  { value: "inspecting", label: "Duke u inspektuar", color: "bg-blue-100 text-blue-800" },
  { value: "confirmed", label: "Perfunduar", color: "bg-green-100 text-green-800" },
...
const tabs = [
  ...
  { value: "inspecting", label: "Duke u inspektuar" },
  { value: "confirmed", label: "Perfunduar" },
