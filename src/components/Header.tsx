                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                    {(session.user as any).role === "ADMIN" && (
                      <Link
                        href="/admin"
                        className="block px-4 py-2 text-sm text-purple-700 font-medium hover:bg-purple-50 transition-colors"
              ...
              {session?.user && (
                <>
                  {(session.user as any).role === "ADMIN" && (
                    <Link
                      href="/admin"
                      className="text-purple-700 hover:text-purple-800 font-medium py-2 px-3 rounded-lg hover:bg-purple-50"
                      onClick={() => setMenuOpen(false)}
                    >
                      Paneli Admin
                    </Link>
